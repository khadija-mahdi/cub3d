...
/*   Updated: 2023/06/27 04:53:29 by kmahdi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	hit_wall(t_data *data, double y, double x)
{
	...
	if (!data->map->map && !data->map->map[(int)floor(y / TILE_SIZE)]
		 && !data->map->map[(int)floor(y / TILE_SIZE)][(int)floor(x
			/ TILE_SIZE)])
		return (0);
	if (data->map->map[(int)(y / TILE_SIZE)][(int)(x
			/ TILE_SIZE)] == '1')
		return (0);
	return (1);
}
...
void	draw_wall_pxl_color(int x, int y, t_data *data, t_rey *rays, int Color)
{
}

void	draw_land_color(t_data *data, t_rey *rays)
{
}
